...
interface ProgramCardEditProps {
...
function CardRoot({ children, hoverable = false, onClick, className, style }: ProgramCardEditProps) {
  return (
    <div
      className={cn(
        styles.card,
...
export const ProgramCardEdit = Object.assign(CardRoot, {
  Header: CardHeader,
  Body: CardBody,
  Footer: CardFooter,
});
